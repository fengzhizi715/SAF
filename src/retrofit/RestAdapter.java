...
public class RestAdapter {
	...
	private class RestHandler implements InvocationHandler {
		...
		public Object invoke(Object proxy, Method method, final Object[] args)
			...
			if (methodInfo.isObservable) {
				...
				return rxSupport
						.createRequestObservable(new RxSupport.Invoker() {
							@Override
	 ...
	 * replacement.
	 */
	Request logAndReplaceRequest(String name, Request request, Object[] args)
			throws IOException {
		...
		if (logLevel.ordinal() >= LogLevel.HEADERS.ordinal()) {
			...
			if (body != null) {
				...
				} else if (logLevel.ordinal() >= LogLevel.HEADERS_AND_ARGS
						.ordinal()) {
					if (!request.getHeaders().isEmpty()) {
						log.log("---> REQUEST:");
					}
