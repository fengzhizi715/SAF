...
public class AndroidLog implements RestAdapter.Log {
	...
	/**
	 * Called one or more times for each call to {@link #log(String)}. The
	 * length of {@code chunk} will be no more than 4000 characters to support
	 * Android's {@link Log} class.
	 */
